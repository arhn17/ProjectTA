...
<div class="container-fluid">
    ...
    <div class="card">
        <div class="body">
            <form method="post" action="{{url('paket/input')}}">
                @csrf
                <div class="card-header">
                    <i class="fa fa-align-justify"></i> <h4>New Package</h4><br>
                </div>
                ...
                <div class="card-body">
                    ...
                    <div class="row clearfix">
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                <div class="form-line">
                                    <input type="number" name="member_price" class="form-control" required>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6">
...
<script type="text/javascript">    
    ...
    function add_service(){
        ...
        $.ajax({
            ...
            html += '<a class="btn btn-sm btn-danger" onclick="remove_service('+no+')" style="margin-top:25px"><i class="material-icons">close</i></a>'
            html += '</div>'
            html += '</div>'
            html += '</div>';
